...
<head>
    ...
    <body class="login" >
        ...
        <div class="logo">
            <a href="index.php">
                <img src="http://niftytrend.in/images/logo.png" alt="logo" style="width: 150px;" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form role="form" action="login.php" method="post">
                ...
                <div class="create-account">
                    <p>
                        <button type="submit" id="register-btn" name="user_login" class="btn green uppercase" onClick="return Validate();">Login</button>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
...
<![endif]-->
    ...
    <script>
		...
		function Validate()
		{
            ...
            var md5passWithSalt = md5pass+"<?php echo $random; ?>";
            var finalPassword = hex_md5(md5passWithSalt);
